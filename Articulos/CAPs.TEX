...
Gestión del riesgo se refiere al proceso de identificar, analizar y responder a factores de riesgo a lo largo de la vida de un proyecto, beneficiando los objetivos propuestos.
...
La neurona no sólo transmite la entrada que recibe, la función de activación utiliza la suma ponderada de la entrada anterior y la transforma como salida. La función sigmoide denotada por \re{funcionSigmoidea}, donde se denota la constante exponencial, que es aproximadamente 2.71828.
