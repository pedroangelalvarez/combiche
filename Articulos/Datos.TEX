...
%\vskip 9cm
%\begin{center}
%   {\bf \doublespacing {\fontsize{17}{20.4}\selectfont{APLICACIÓN DE SISTEMAS INTELIGENTES PARA LA CLASIFICACIÓN AUTOMÁTICA DE DOCUMENTOS }}}     
%\end{center} 
%\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%      {\bf {\fontsize{14}{16.8}\selectfont{LUIS ANTHONY CONTRERAS PUMAMANGO}}}       
%   \end{center}   
%
%%\vskip 3.2cm
%\begin{center}
...
%
%%\vskip 1.5cm 
%{\fontsize{14}{16.8}\selectfont ASESOR: Mg. YENNY MILAGRITOS SIFUENTES DÍAZ} 
% \vskip 1cm 
% \begin{center}    
% \vskip 2cm
...
% \vskip 1.5cm
%  {\Large Aplicación de Sistemas Inteligentes para la Clasificación Automática de Documentos }}
% \vskip 1cm 
%  {\large{Paul Denis Sanchez Rodriguez}}\\
%    {\large{Luis Anthony Contreras Pumamango}}
%
% \vskip 1cm
%\end{center} 
...
%\vskip 0.8cm 
%\begin{center}    
%Trujillo, 11 de noviembre del 2019
%\end{center} 
%\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
